...
graph LR
    ...
    style Transformer fill:#e834,stroke:#005a9e,stroke-width:2px
        ...
        %% Encoder-Decoder Attention Connection (MOST IMPORTANT CHANGE)
    ...
    subgraph Encoder_Layer["Encoder Layer Detail"]
        style Encoder_Layer fill:#cc22,stroke:#005a9e,stroke-width:1px
    ...
    style Decoder_Layer fill:#2ff4,stroke:#005a9e,stroke-width:1px
